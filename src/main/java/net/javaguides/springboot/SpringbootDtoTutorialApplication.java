...
public class SpringbootDtoTutorialApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		location.setPlace("XYZ");
		location.setDescription("XYZ is great place to live");
		...
		User user2 = new User();
		user2.setFirstName("Taylor");
		user2.setLastName("Swift");
		user2.setEmail("taylor@gmail.com");
